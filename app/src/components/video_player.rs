...
pub fn VideoPlayer(#[prop(into)] src: Signal<Option<String>>) -> impl IntoView {
    ...
    view! {
        ...
        >
            ...
            <div class="absolute h-full w-full top-0 left-0 bg-black/70 opacity-0 hover:opacity-100
            ...
            >
                ...
                <button type="button" class="text-2xl font-bold2"
                    on:click = move|_|{
                        match video_state.get_untracked(){
                            ...
                            state => {
                                info!("Cant do anything in state {state}")
                            }
                        }
                        ...
                        if let (Some(elapsed), Some(total)) = (current_time.get(), duration.get()){
                            view! {
                                <div class="absolute w-[90%] top-[80%] left-[5%] h-4 bg-white/45">
                                    <div class="absolute top-0 left-0 h-full bg-white"
